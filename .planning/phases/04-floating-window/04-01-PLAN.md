...
must_haves:
  ...
  artifacts:
    ...
    - path: "ClaudeMon/Utilities/NSWindow+Position.swift"
...
<task type="auto">
  ...
  <files>ClaudeMon/Utilities/NSWindow+Position.swift</files>
  <action>
...
<task type="auto">
  ...
  <files>ClaudeMon/Services/FloatingWindowController.swift</files>
  <action>
