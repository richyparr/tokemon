...
must_haves:
  ...
  artifacts:
    ...
    - path: "Tokemon/Models/LicenseState.swift"
      provides: "License state machine enum"
      contains: "enum LicenseState"
    - path: "Tokemon/Services/LicenseManager.swift"
      provides: "Core licensing logic"
      exports: ["LicenseManager"]
    - path: "Tokemon/Services/LicenseStorage.swift"
      provides: "Secure Keychain storage for license data"
      contains: "KeychainAccess"
  key_links:
    - from: "Tokemon/Services/LicenseManager.swift"
      to: "Tokemon/Services/LicenseStorage.swift"
...
@/Users/richardparr/Tokemon/.planning/ROADMAP.md
...
<task type="auto">
  ...
  <action>
    ...
    2. Add LemonSqueezy constants to Constants.swift:
       ...
       static let licenseKeychainService = "com.tokemon.license"
       ```
...
<task type="auto">
  ...
  <files>Tokemon/Services/LicenseManager.swift</files>
  <action>
