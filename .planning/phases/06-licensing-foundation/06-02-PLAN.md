...
must_haves:
  ...
  artifacts:
    - path: "Tokemon/Views/Licensing/TrialBannerView.swift"
      provides: "Trial status banner for popover"
      contains: "TrialBannerView"
    - path: "Tokemon/Views/Licensing/PurchasePromptView.swift"
      provides: "Purchase prompt modal"
      contains: "PurchasePromptView"
    - path: "Tokemon/Views/Settings/LicenseSettings.swift"
  ...
  key_links:
    - from: "Tokemon/TokemonApp.swift"
      to: "Tokemon/Services/LicenseManager.swift"
    ...
    - from: "Tokemon/Views/MenuBar/PopoverContentView.swift"
      to: "Tokemon/Views/Licensing/TrialBannerView.swift"
      via: "Conditional rendering based on license state"
      pattern: "TrialBannerView"
    - from: "Tokemon/Views/Settings/LicenseSettings.swift"
      to: "LicenseManager"
...
<context>
@/Users/richardparr/Tokemon/.planning/PROJECT.md
@/Users/richardparr/Tokemon/.planning/phases/06-licensing-foundation/06-RESEARCH.md
@/Users/richardparr/Tokemon/.planning/phases/06-licensing-foundation/06-01-SUMMARY.md
...
- TokemonApp: Add LicenseManager as @State, pass via .environment()
...
<task type="auto">
  ...
  <action>
    1. Create directory structure if needed: Tokemon/Views/Licensing/
