...
@/Users/richardparr/Tokemon/.planning/phases/06-licensing-foundation/06-02-SUMMARY.md
...
<task type="auto">
  ...
  <files>Tokemon/Services/FeatureAccessManager.swift</files>
  <action>
...
<task type="auto">
  ...
  <action>
    Update TokemonApp.swift to initialize and distribute FeatureAccessManager:
    ...
    The key change to TokemonApp init:
    ```swift
    init() {
...
<task type="auto">
  ...
  <action>
    ...
    4. Add ProBadge and ProLockIcon to a shared location.
       Create Tokemon/Views/Components/ProBadge.swift:
       ```swift
       import SwiftUI
