...
files_modified:
  ...
  - Tokemon/Views/MenuBar/RefreshStatusView.swift
  - Tokemon/Views/MenuBar/ErrorBannerView.swift
  - Tokemon/Views/Settings/SettingsView.swift
  - Tokemon/Views/Settings/DataSourceSettings.swift
  - Tokemon/Views/Settings/RefreshSettings.swift
  - Tokemon/Views/Settings/AppearanceSettings.swift
  - Tokemon/Utilities/Extensions.swift
...
must_haves:
  ...
  artifacts:
    ...
    - path: "Tokemon/Views/Settings/DataSourceSettings.swift"
      provides: "Enable/disable OAuth and JSONL sources"
      exports: ["DataSourceSettings"]
    - path: "Tokemon/Views/Settings/RefreshSettings.swift"
...
**Update TokemonApp.swift -- Add right-click context menu:**
...
- Context menu items:
  ...
  - Separator
  - "Quit Tokemon" (Cmd+Q) -- calls `NSApplication.shared.terminate(nil)`
...
**Also update TokemonApp.swift for status item appearance updates:**
...
7. "Quit Tokemon" terminates the app
...
4. Right-click: Right-click the menu bar icon -- a context menu should appear with "Refresh Now", "Settings...", "Quit Tokemon"
