...
must_haves:
  ...
  key_links:
    ...
    - from: "Tokemon/Views/MenuBar/UsageHeaderView.swift"
...
- Add `static let defaultAlertThreshold = 80`
  ...
  <verify>
`swift build` succeeds. AlertManager.swift exists at Tokemon/Services/AlertManager.swift with AlertLevel enum, checkUsage method, and threshold settings.
  </verify>
  <done>
...
- TokemonApp injects alertManager into environment
