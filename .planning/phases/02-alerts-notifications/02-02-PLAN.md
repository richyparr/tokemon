...
**TokemonApp.swift additions:**

1. Add import: `import UserNotifications`

2. Add `@NSApplicationDelegateAdaptor private var appDelegate: AppDelegate` to TokemonApp struct

3. In TokemonApp.init(), set the notification delegate:
   ```swift
   init() {
...
**Build and run:** `swift build && .build/debug/Tokemon`
