...
<task type="auto">
  ...
  <files>ClaudeMon/Views/Analytics/AnalyticsDashboardView.swift</files>
  <action>
...
Button exists: `grep "Share Usage Card" ClaudeMon/Views/Analytics/AnalyticsDashboardView.swift`
Pro gating: `grep ".usageCards" ClaudeMon/Views/Analytics/AnalyticsDashboardView.swift`
  </verify>
...
6. Image should show: ClaudeMon branding, utilization %, optional project/tokens, claudemon.app URL
...
5. Pasted image shows ClaudeMon branding and usage stats
...
- Usage card includes ClaudeMon branding (SHARE-03)
