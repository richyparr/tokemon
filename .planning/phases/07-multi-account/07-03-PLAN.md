...
must_haves:
  ...
  artifacts:
    - path: "ClaudeMon/Views/Settings/CombinedUsageView.swift"
    ...
    - path: "ClaudeMon/Services/HistoryStore.swift"
      ...
      contains: "accountId"
  key_links:
    - from: "ClaudeMon/Views/Settings/CombinedUsageView.swift"
...
Also update UsageMonitor to pass account ID to HistoryStore when recording:
...
- HistoryStore uses per-account files in ClaudeMon/history/
