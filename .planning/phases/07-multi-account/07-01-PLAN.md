...
must_haves:
  ...
  key_links:
    ...
    - from: "ClaudeMon/Services/TokenManager.swift"
      to: "KeychainAccess"
...
<task type="auto">
  ...
  <action>
**Constants.swift:**
Add new constant for ClaudeMon's own account metadata storage (separate from Claude Code's credentials):
```swift
