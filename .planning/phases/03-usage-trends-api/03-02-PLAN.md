...
must_haves:
  ...
  artifacts:
    - path: "Tokemon/Services/BurnRateCalculator.swift"
    ...
    - path: "Tokemon/Views/Charts/BurnRateView.swift"
  ...
  key_links:
    ...
    - from: "Tokemon/Views/Charts/BurnRateView.swift"
      to: "Tokemon/Services/BurnRateCalculator.swift"
      via: "burn rate calculation"
      pattern: "BurnRateCalculator\\."
    - from: "Tokemon/Views/MenuBar/PopoverContentView.swift"
      to: "Tokemon/Views/Charts/UsageChartView.swift"
...
<task type="auto">
  ...
  <files>Tokemon/Services/BurnRateCalculator.swift</files>
  <action>
...
<task type="auto">
  ...
  <files>Tokemon/Views/Charts/UsageChartView.swift</files>
  <action>
...
Create `Tokemon/Views/Charts/BurnRateView.swift`:
...
Modify `Tokemon/Views/MenuBar/PopoverContentView.swift`:
