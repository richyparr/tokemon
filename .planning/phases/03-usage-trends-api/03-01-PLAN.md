...
must_haves:
  ...
  artifacts:
    - path: "Tokemon/Models/UsageDataPoint.swift"
  ...
  key_links:
    ...
    - from: "Tokemon/Services/HistoryStore.swift"
      to: "Application Support/Tokemon/usage_history.json"
      via: "JSON file I/O"
...
<task type="auto">
  ...
  <files>Tokemon/Models/UsageDataPoint.swift</files>
  <action>
...
<task type="auto">
  ...
  <files>Tokemon/Services/HistoryStore.swift</files>
  <action>
...
/// Persists data as JSON to Application Support/Tokemon/usage_history.json.
...
<task type="auto">
  ...
  <files>Tokemon/Services/UsageMonitor.swift</files>
  <action>
...
2. Run app, check that ~/Library/Application Support/Tokemon/usage_history.json is created after first refresh
  </verify>
...
3. After app runs for 1-2 refresh cycles, check file exists:
   `cat ~/Library/Application\ Support/Tokemon/usage_history.json | head -20`
