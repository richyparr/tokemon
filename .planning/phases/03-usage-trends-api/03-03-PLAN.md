...
must_haves:
  ...
  artifacts:
    ...
    - path: "Tokemon/Views/Settings/AdminAPISettings.swift"
      provides: "Admin API configuration UI"
      contains: "struct AdminAPISettings"
  key_links:
    - from: "Tokemon/Views/Settings/AdminAPISettings.swift"
    ...
    - from: "Tokemon/Views/Settings/SettingsView.swift"
      to: "Tokemon/Views/Settings/AdminAPISettings.swift"
      via: "settings tab"
...
<task type="auto">
  ...
  <files>Tokemon/Models/AdminUsageResponse.swift</files>
  <action>
...
<task type="auto">
  ...
  <files>Tokemon/Services/AdminAPIClient.swift</files>
  <action>
...
actor AdminAPIClient {
    ...
    private let keychain = Keychain(service: "com.tokemon.admin-api")
    ...
    nonisolated func hasAdminKey() -> Bool {
        ...
        (try? Keychain(service: "com.tokemon.admin-api").get("admin_api_key")) != nil
    }
