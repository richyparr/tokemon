...
must_haves:
  ...
  artifacts:
    - path: "ClaudeMon/Services/AnalyticsEngine.swift"
    ...
    - path: "ClaudeMon/Models/UsageSummary.swift"
      provides: "UsageSummary model for weekly/monthly data"
      contains: "struct UsageSummary"
    - path: "ClaudeMon/Models/ProjectUsage.swift"
    ...
    - path: "ClaudeMon/Views/Analytics/ExtendedHistoryChartView.swift"
    ...
    - path: "ClaudeMon/Views/Settings/SettingsView.swift"
      ...
      contains: "Analytics"
  key_links:
    - from: "ClaudeMon/Views/Analytics/AnalyticsDashboardView.swift"
      to: "ClaudeMon/Services/AnalyticsEngine.swift"
      via: "Calls AnalyticsEngine static methods for data"
      pattern: "AnalyticsEngine\\."
    - from: "ClaudeMon/Views/Analytics/ExtendedHistoryChartView.swift"
      to: "ClaudeMon/Services/HistoryStore.swift"
      via: "Gets history data via UsageMonitor.usageHistory"
      pattern: "dataPoints"
    - from: "ClaudeMon/Views/Analytics/ProjectBreakdownView.swift"
      to: "ClaudeMon/Services/AnalyticsEngine.swift"
    ...
    - from: "ClaudeMon/Views/Settings/SettingsView.swift"
      to: "ClaudeMon/Views/Analytics/AnalyticsDashboardView.swift"
...
4. `static func decodeProjectPath(_ dirName: String) -> String`
   - Helper: Convert "-Users-richardparr-ClaudeMon" to "/Users/richardparr/ClaudeMon"
