...
final class AccountManager {
    ...
    /// Scan Claude Code's keychain for accounts not yet registered in Tokemon.
    /// Users run `claude login` externally, then Tokemon detects and imports the new credentials.
