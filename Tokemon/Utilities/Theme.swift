...
struct ThemeColors {
    ...
    /// Whether this theme uses Liquid Glass effects.
    var isGlass: Bool { theme == .liquidGlass }

    /// Primary background color for views.
    /// Returns .clear for Liquid Glass so glass can show through.
